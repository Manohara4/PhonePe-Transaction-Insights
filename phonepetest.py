...
if select == "Home":
    ...
    with col2:
        st.image(Image.open(r"C:\Users\ASUS\Desktop\Phonepe\OIP.jpg"),width=600)


    col3,col4= st.columns(2)
    with col3:

        st.image(Image.open(r"C:\Users\ASUS\Desktop\Phonepe\OIP11.jpg"),width=600)
    with col4:
    ...
    with col6:
        st.image(Image.open(r"C:\Users\ASUS\Desktop\Phonepe\OIP222.jpg"),width=600)
